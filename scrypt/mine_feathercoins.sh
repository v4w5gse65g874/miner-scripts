...
#THIS IS 7970
./cgminer --scrypt -I 13 -g 2 -w 256 --thread-concurrency 8192 --gpu-engine 1140 --gpu-memclock 1500 --gpu-powertune 20 --gpu-vddc 1.170 --temp-target 60 --auto-fan -o stratum+tcp://ftc.give-me-coins.com:3336 -u $MINERU1 -p $MINERP1 --failover-only -o stratum+tcp://coinotron.com:3337 -u $MINERU2 -p $MINERP2
